...
def calcular_targets(dataset, pop_norm, tipo_dado, thresholds, janela=7):
    ...
    plt.savefig('distribuicao_classes_brazil.pdf', format='pdf', bbox_inches='tight')
    plt.close()  # Fecha a figura para não ser exibida no notebook/script

    print("Figura com a distribuição das classes foi salva em 'distribuicao_classes_brazil.pdf'")
