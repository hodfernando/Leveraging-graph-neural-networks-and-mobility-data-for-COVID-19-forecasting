...
if __name__ == '__main__':
    ...
    for city in range(train_data.shape[1]):
        ...
        result = run_prophet(city, train_data_pr, test_data_pr)

        pred_prophet[:, city] = result['yhat'][-test_data[:, city].shape[0]:].values
        ...
        prophet_r2_city[city] = r2_score(test_data[:, city],
                                         result['yhat'][-test_data[:, city].shape[0]:].values)
